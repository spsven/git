<#-- @ftlvariable name="notifyForbidden" type="String" -->
...
<#else>
    ...
    <#else>
        ...
        <#if course??>
            ...
            <form action="./notify" method="post" class="form-horizontal">
                <fieldset>
                    <!-- Course Name -->
                    ...
                    <div class="form-actions">
                        <button id="notifyButton" class="btn btn-warning" type="submit">Notify</button>
