<#-- @ftlvariable name="finishForbidden" type="String" -->
...
<#else>
    ...
    <#else>
        ...
        <#if course??>
            ...
            <form action="./finish" method="post" class="form-horizontal">
                <fieldset>
                    <!-- Course Name -->
                    ...
                    <div class="form-actions">
                        <button id="finishButton" class="btn btn-warning" type="submit">Finish</button>
